...
<head>
  <meta charset="utf-8">
  <title>Admin Area - IMR Entertainment</title>
  ...
  <link href="<?= $baseUrl ?>admin/layouts/custom.css" rel="stylesheet">
</head>
    ...
    <div class="sidebar pe-4 pb-3">
      <nav class="navbar bg-secondary navbar-dark">
        ...
        <div class="navbar-nav w-100">
          ...
          <a href="user.php" class="nav-item nav-link"><i class="fa fa-users me-2"></i>Data User</a>
          <!-- <a href="#" class="nav-item nav-link"><i class="fa fa-headphones me-2"></i>Submit Album</a>
          <a href="#" class="nav-item nav-link"><i class="fa fa-history me-2"></i>Requests</a> -->
          <a href="#" class="nav-item nav-link"><i class="fa fa-phone me-2"></i>Contact Admin</a>
