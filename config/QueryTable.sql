...
CREATE TABLE IF NOT EXISTS singles (
  ...
  id_album BIGINT UNSIGNED NOT NULL,
	nama_single VARCHAR(255) NOT NULL,
  tanggal_rilis DATE NOT NULL,
	genre_single VARCHAR(255) NOT NULL,
	cover_single VARCHAR(255) NULL,
  lokasi_file_cover TEXT NULL,
	file_single VARCHAR(255) NULL,
  lokasi_file_single TEXT NULL,
  user_id BIGINT UNSIGNED NOT NULL,
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	PRIMARY KEY (id)
